    ...
    <body class="w3-small" style="background-color:#cccccc;">
        ...
        <div class="w3-content marginKhusus1 w3-padding" style="max-width:1564px">
            <div class="w3-container w3-white w3-topbar w3-bottombar w3-leftbar w3-rightbar w3-round-large w3-padding">
                ...
                <h3>Tabel singkat semua produk Fanaha Mart</h3>
                        ...
                        foreach ($_SESSION["data_produk"] as $item){
                            ...
                            echo"
                                <tr>
                                    ...
                                    <td style=\"text-align:center;\"><a href=\"daftar_produk.php?delete_daftar_produk=true&kodeHapus_daftar_produk="
                                        .$item['kode']."\"><i class=\"fas fa-trash-alt\" style=\"font-size:16px; color:red; \"></i></a></td>
                                    <td style=\"text-align:center;\"><a href=\"edit_produk.php?edit_daftar_produk=true&kodeEdit_daftar_produk="
                                        .$item['kode']."\"><i class=\"fas fa-edit\" style=\"font-size:16px; \"></i></a></td>
                                </tr>";                                        
                        }
                            echo"			
                        </table>";	
