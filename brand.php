    ...
    <body class="w3-small" style="background-color:#cccccc;">
        ...
        <div class="w3-top">
            <div class="w3-bar w3-white w3-medium w3-padding w3-card">
                ...
                <!-- <a href="index.php#home" class="w3-bar-item w3-button"><b><span style="color:#1b594a">Fanaha</span>
                    </b> <span style="color:#f28439">Mart</span></a> -->
            ...
            <div class="w3-right">
                ...
                if(isset($_SESSION['user'])){
                    echo "<a href=\"member.php\" class=\"w3-bar-item w3-button w3-border-right w3-hide-small\">".$_SESSION['user']['username_log']."</a>
                        <a href=\"brand.php?out=true\" class=\"w3-bar-item w3-button w3-hide-small\">Log Out</a>";
                }else{
            ...
            <div id="demo" class="w3-bar-block w3-hide w3-hide-large w3-hide-medium">
                <a href="index.php#about" class="w3-bar-item w3-button">Tentang Kami</a>
                <?php
                if(isset($_SESSION['user'])){
                    echo "<a href=\"member.php\" class=\"w3-bar-item w3-button w3-border-right\">".$_SESSION['user']['username_log']."</a>
                        <a href=\"brand.php?out=true\" class=\"w3-bar-item w3-button\">Log Out</a>";
                }else{
                    echo"<a onclick=\"login()\" 
        ...
        <div class="w3-content marginKhusus1 w3-padding" style="max-width:1564px">
            ...
            <div class="w3-container w3-white w3-topbar w3-bottombar w3-leftbar w3-rightbar w3-round-large">
                ...
                <div class="w3-row">
                    <div class="w3-half w3-container">
                        <p style="text-align:left;"><b>Official Lainnya</b></p>
                    </div>
                </div> 
                <div class="w3-row-padding">
                    <?php
                        if(isset($_SESSION['brand_mini'])){
                            foreach($_SESSION['brand_mini'] as $info_item){
                                echo 
                                "<div class=\"w3-col l2 s4\">
                                    <div class=\"w3-display-container\">
                                    <p>".$info_item['nama']."</p>
