        ...
        <div class="w3-top">
            <div class="w3-bar w3-white w3-medium w3-padding w3-card">
                ...
                <div id="demo" class="w3-bar-block w3-hide w3-hide-large w3-hide-medium">
                    ...
                    <a href="pakaian.php" class="w3-bar-item w3-button">Pakaian</a>
                    ...
                    <?php
                        if(isset($_SESSION['user'])){
                            echo "<a href=\"member.php\" class=\"w3-bar-item w3-button w3-border-right\">".$_SESSION['user']['username_log']."</a>
                                <a href=\"index.php?out=true\" class=\"w3-bar-item w3-button\">Log Out</a>";
                        }else{
                            echo"<a onclick=\"login()\" 
            ...
            <div class="w3-row w3-padding w3-hide-small w3-white border-upMenuBar ">
                ...
                <div class="w3-col  w3-container" style="width:60%">
                    <div class="w3-row">
                        ...
                        <div class="w3-center w3-container w3-quarter">
                            <a href="pakaian.php" class="w3-bar-item w3-button w3-hide-small">Pakaian</a>
                        </div>
                    </div>  
                </div>
                <div class="w3-col  w3-container" style="width:20%"></div>
                            ...
                            echo"                
                                <div class=\"w3-row\">
                                    <div class=\"w3-container w3-third w3-rightbar\">
                                        <img src=\"".$_SESSION['data_produk'][$_GET['kodeProduk']]['gbr']."\" alt=\"venue\" style=\"width:100%;max-width:400px\" />
                                    </div>                    
                                    <div class=\"w3-container w3-twothird\">
                                        <div>
                                            <h4>".$_SESSION['data_produk'][$_GET['kodeProduk']]['nama']."</h4>
                                        </div>
                                        <div class=\"w3-row\">
                                            <div class=\"w3-third w3-container\">";
                                                if($_SESSION['data_produk'][$_GET['kodeProduk']]['diskon'] > 0){                                              
                                                    echo "<span class=\"fontHargaPromo\"><strike>Rp. ".number_format($_SESSION['data_produk'][$_GET['kodeProduk']]['harga'],0,",",".").
                                                            "</strike></span>
                                                        <span class=\"w3-tag w3-round bgcolorOrange w3-center\">".
                                                        $_SESSION['data_produk'][$_GET['kodeProduk']]['diskon']."%</span></h4>
                                                        <h4>Rp. ".number_format(hasilHargaDisko($_SESSION['data_produk'][$_GET['kodeProduk']]['harga'], 
                                                        $_SESSION['data_produk'][$_GET['kodeProduk']]['diskon']),0,",",".");                                                           
                                                    
                                                }else{
                                                    echo "<h4>Rp. ".number_format($_SESSION['data_produk'][$_GET['kodeProduk']]['harga'],0,",",".")."</h4>";
                                                }
                                            echo 
                                            "</div>
                                            <div class=\"w3-twothird w3-container\">
                                                <form action=\"produk_desc.php?kode=".$_SESSION['data_produk'][$_GET['kodeProduk']]['kode']."\" method=\"post\">
                                                    <div class=\"w3-row\">
                                                        <div class=\"w3-half w3-container\">
                                                            <label>Kuantitas (minimal 1 unit)</label>
                                                            <input type=\"number\" name=\"quantity_produk_desc\" min=\"1\" max=\"50\" \>
                                                        </div>
                                                        <div class=\"w3-half w3-container\">
                                                            <input class=\"w3-button bgcolorIjo w3-text-white w3-round w3-padding-large\" type=\"submit\" value=\"Beli\" \>
                                                        </div>
                                                    </div>                                        
                                                </form>
                                            </div>
                                        ...
                                        <div>
                                            <h5>Keterangan</h5><p>".$_SESSION['data_produk'][$_GET['kodeProduk']]['lain1']."</p>
                                            <p>".$_SESSION['data_produk'][$_GET['kodeProduk']]['lain2']."</p>
                                            <p>".$_SESSION['data_produk'][$_GET['kodeProduk']]['lain3']."</p>
                                        </div>
                                    </div>
                                </div>";
                        }else{
        ...
        <footer class="w3-center w3-white w3-padding w3-border">
            <div class="w3-row">
                ...
                <div class="w3-container w3-center w3-white w3-third">
                    <div class="w3-row">
                        <div class="w3-half w3-container">
                            <p style="text-align:left;">Jasa Pengiriman</p>
                        </div>
                    </div> 
                    <img src="gambar/aksesoris_page/pengiriman.jpg" alt="venue" style="width:100%" />
