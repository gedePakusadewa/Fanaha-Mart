    ...
    <body class="w3-small" style="background-color:#cccccc;">
                    ...
                    <?php
                        if(isset($_SESSION['user'])){
                            echo "<a href=\"member.php\" class=\"w3-bar-item w3-button w3-border-right w3-hide-small\">".$_SESSION['user']['username_log']."</a>
                                <a href=\"kosmetik.php?out=true\" class=\"w3-bar-item w3-button w3-hide-small\">Log Out</a>";
                        }else{
                    ...
                    <?php
                        if(isset($_SESSION['user'])){
                            echo "<a href=\"member.php\" class=\"w3-bar-item w3-button w3-border-right\">".$_SESSION['user']."</a>
                                <a href=\"kosmetik.php?out=true\" class=\"w3-bar-item w3-button\">Log Out</a>";
                        }else{
                            echo"<a onclick=\"login()\" 
        ...
        <div class="w3-content marginKhusus1 w3-padding" style="max-width:1564px">
                                        ...
                                        "<div class=\"w3-col l2 m4 w3-margin-bottom\">
                                            ...
                                            <a href=\"produk_desc.php?kodeProduk=".$info_item['kode']."\" >
                                                ...
                                                <div class=\"w3-padding\">
                                                    ...
                                                    <div class=\"w3-center\">
                                                        <a href=\"kosmetik.php?kodeProdukBeli=".$info_item['kode']."\" 
            ...
            <div class="w3-container w3-white w3-topbar w3-bottombar w3-leftbar w3-rightbar w3-round-large">
                <div class="w3-row">
                    <div class="w3-half w3-container">
                        <p style="text-align:left;"><b>Kesehatan dan Perawatan Tubuh</b></p>
                    </div>
                </div> 
                                    ...
                                    if((int)$info_item['diskon'] === 0){
                                        ...
                                        "<div class=\"w3-col l2 m4 w3-margin-bottom\">
                                            ...
                                            <a href=\"produk_desc.php?kodeProduk=".$info_item['kode']."\" >
                                                ...
                                                <div class=\"w3-padding\">
                                                    <h6>".$info_item['nama']."</h6>
                                                    <span class=\"w3-large\">Rp. ".number_format($info_item['harga'],0,",",".")."</span>
                                                    <div class=\"w3-center\">
                                                        <a href=\"kosmetik.php?kodeProdukBeli=".$info_item['kode']."\" 
                                                            class=\"w3-button bgcolorIjo w3-text-white\" style=\"width:65%;\" >Beli</a>
                                                    </div>                                            
